...
begin
  ShowMessage('W - вверх  S - вниз  A - влево  D - вправо  Пробел - огонь' + #13#10 + '(Игрок 2) 8 - вверх  2 - вниз  4 - влево  5 - вправо  0 - огонь' + #13#10 + 'ESC - Пауза  R - Начать заново  I - Начать');
end;
...
begin
  ...
  with ADOQuery1 do begin
        ...
        while i<>RecordCount do begin
          if strtoint(FieldValues['Счет'])>max then begin
            max:=strtoint(FieldValues['Счет']);
            maxname:= FieldValues['Игрок'];
          end;
          next;
          inc(i);
        end;
